...
public interface RepairCenterRepository extends JpaRepository<RepairCenter, Long> {
    @Query("select new com.repair.api.dto.response.repairCenter.RepairCenterListResponseDto(createAt, name, address, tell, brand) from repair_center ")
